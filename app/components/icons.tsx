...
export const ImageIcon = ({ isActive = false }: { isActive?: boolean }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={`w-full h-full ${isActive ? "text-black" : "text-current"}`}
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const Home = ({ isActive = false }) => {
  return (
    <svg
      className={`w-full h-full ${isActive ? "text-black" : "text-current"}`}
      viewBox="0 0 24 24"
...
export const VideoIcon = ({ isActive = false }) => {
  return (
    <svg
      className={`w-full h-full ${isActive ? "text-black" : "text-current"}`}
      viewBox="0 0 24 24"
...
export const Enhancer = ({ isActive = false }) => {
  return (
    <svg
      className={`w-full h-full ${isActive ? "text-black" : "text-current"}`}
      viewBox="0 0 24 24"
...
export const Edit = ({ isActive = false }) => {
  return (
    <svg
      className={`w-full h-full ${isActive ? "text-black" : "text-current"}`}
      viewBox="0 0 24 24"
...
export const Realtime = ({ isActive = false }) => {
  return (
    <svg
      className={`w-full h-full ${isActive ? "text-black" : "text-current"}`}
      viewBox="0 0 24 24"
...
export const AssetIcon = ({ isActive = false }) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
